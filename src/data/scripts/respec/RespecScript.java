...
public class RespecScript implements EveryFrameScript
{
    ...
    private int getLevel()
    {
        ...
        return (int) Math.max(1f, Math.min(MAX_LEVEL_SUPPORTED, player.getLevel()));
    }
    ...
    private void checkStationInventories()
    {
        ...
        for (Iterator systems = Global.getSector().getStarSystems().iterator(); systems.hasNext();)
        {
            system = (StarSystemAPI) systems.next();
